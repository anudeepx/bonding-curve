...
pub const BONDING_CURVE_SUPPLY: u64 = 793_100_000 * SCALE; // total token supply allocated to bonding curve

pub const SCALE: u64 = 1_000_000; // scaling factor for precision for token decimals
